...
3. Implementar
4. Crear o actualizar tests (ver sección 9)
5. Ejecutar pruebas y validar
6. Cambiar estado a `done` (o `needs_review` si requiere aprobación humana)
7. Actualizar `backlog.json` con `summary` y `tests`
8. Actualizar `docs/00_estado_actual.md`
9. Commit con formato de convención
