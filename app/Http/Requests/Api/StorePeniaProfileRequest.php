...
class StorePeniaProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug' => ['nullable', 'string', 'max:255', Rule::unique('penia_profiles', 'slug')],
            ...
            'venue_type' => ['required', Rule::in(['penia', 'centro_cultural', 'gastronomico_cultural', 'otro'])],
            ...
            'verification_status' => ['required', Rule::in(['pending', 'verified', 'outdated'])],
            ...
            'editorial_status' => ['nullable', Rule::in(['draft', 'approved', 'published', 'archived'])],
