...
class PeniaProfileRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'city' => 'nullable|string|max:255', 'address' => 'nullable|string|max:255', 'latitude' => 'nullable|numeric|between:-90,90', 'longitude' => 'nullable|numeric|between:-180,180', 'venue_type' => ['required', Rule::in(['penia', 'centro_cultural', 'gastronomico_cultural', 'otro'])],
