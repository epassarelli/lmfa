    ...
    <div class="flex space-x-4">
      ...
      <a href="https://www.instagram.com/mifolkloreargentino/" target="_blank" aria-label="Instagram">
        <svg class="w-6 h-6 transition-opacity hover:opacity-80" viewBox="0 0 24 24">
          <defs>
            <linearGradient id="ig-gradient-sidebar" x1="0%" y1="100%" x2="100%" y2="0%">
              <stop offset="0%" stop-color="#FFDD55" />
              <stop offset="50%" stop-color="#E1306C" />
              <stop offset="100%" stop-color="#833AB4" />
            </linearGradient>
          </defs>
          <path fill="url(#ig-gradient-sidebar)"
      ...
      <a href="https://x.com/MiFolkloreArg" target="_blank" aria-label="X">
        <svg class="w-6 h-6 text-black hover:text-gray-700 transition-colors" viewBox="0 0 24 24"
          fill="currentColor">
          <path
