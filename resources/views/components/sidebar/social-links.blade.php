<div>
  ...
  <div class="bg-white p-2 rounded shadow-sm mb-6">
    <h3 class="text-md font-semibold text-gray-800 mb-2 pb-1 border-b-2 border-[#ff661f]">
      Seguinos</h3>
    <div class="flex space-x-3">
      ...
      <a href="https://x.com/MiFolkloreArg" target="_blank" aria-label="X"
        class="flex h-11 w-11 items-center justify-center rounded-lg bg-black transition-transform hover:scale-110">
        <svg class="w-5 h-5" fill="#ffffff" viewBox="0 0 24 24">
          <path
