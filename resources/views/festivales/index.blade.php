...
@section('content')
  ...
  <div class="container mx-auto py-8">
    ...
    <p>Descubre la magia de las fiestas y festivales folklóricos en nuestra sección dedicada a los eventos que celebran la
    ...
    <p>Cada festival y fiesta está detalladamente descrito, ofreciendo información sobre las fechas, ubicaciones,
      ...
      de ellos.</p>
    <p>Sumérgete en el espíritu festivo del folklore argentino y únete a las celebraciones que honran nuestras tradiciones
    ...
    <div class="row">
      ...
      <div class="col-md-3 mb-4">
        <div class="card">
          <img src="https://via.placeholder.com/300x200" class="card-img-top" alt="Provincia de Catamarca">
          <div class="card-body text-center">
            <h5 class="card-title">Catamarca</h5>
            <a href="festivales/provincia/catamarca" class="btn btn-primary">Ver Festivales</a>
          </div>
        </div>
      </div>

      <!-- Repetir el bloque de tarjeta para cada una de las 24 provincias -->

      <div class="col-md-3 mb-4">
        <div class="card">
          <img src="https://via.placeholder.com/300x200" class="card-img-top" alt="Provincia de Córdoba">
          <div class="card-body text-center">
            <h5 class="card-title">Córdoba</h5>
            <a href="festivales/provincia/cordoba" class="btn btn-primary">Ver Festivales</a>
          </div>
        </div>
      </div>

      <!-- Añadir tarjetas para todas las provincias restantes -->
          ...
          <div class="card h-100">
            <a href="{{ route('festivales.show', $festival->slug) }}">
              <img src="{{ asset('storage/festivales/' . $festival->foto) }}" alt="{{ $festival->titulo }}"
                class="card-img-top">
              <div class="card-body">
                <h5 class="card-title">{{ $festival->titulo }}</h5>
              </div>
            </a>
          </div>
        </div>
