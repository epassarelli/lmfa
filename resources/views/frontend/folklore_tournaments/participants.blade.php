...
@section('content')
  ...
  <section class="mt-8 rounded-lg bg-white p-6 shadow-sm">
    ...
    <p class="mt-2 text-sm text-stone-600">Los 32 interpretes que forman parte de la Copa del Folklore Argentino 2026.</p>
      ...
      @foreach ($participants as $participant)
        <article class="overflow-hidden rounded-lg border border-stone-200 bg-stone-50">
          ...
          <div class="p-4">
            ...
            <p class="mt-2 text-sm text-stone-600">Seed {{ $participant->seed_order ?? '-' }}</p>
            <p class="mt-1 text-xs text-stone-500">ID interprete: {{ $participant->artist_id ?? '-' }}</p>
