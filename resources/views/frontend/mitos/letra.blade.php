...
@section('content')
  <div class="max-w-7xl mx-auto px-4 py-8">
    ...
    <section class="mb-10">
      ...
      <p class="text-lg text-gray-700 mb-4">Bienvenidos a nuestra sección de mitos y leyendas tradicionales, donde exploramos las historias y relatos que forman parte del rico patrimonio cultural del folklore argentino...</p>
    ...
    <section class="mb-16">
      ...
      <p class="text-gray-700 mb-6">Descubre relatos tradicionales organizados alfabéticamente que enriquecen nuestra tradición cultural...</p>
    ...
    <section class="mb-16">
      ...
      <p class="text-gray-700 mb-6">Estas historias, llenas de misterio y tradición, son las más populares en nuestro portal...</p>
