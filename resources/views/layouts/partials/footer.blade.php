      ...
      <div>
        ...
        <div class="flex space-x-4">
          <a href="https://www.facebook.com/MiFolkloreArgentino/" target="_blank" aria-label="Facebook">
            <svg class="w-6 h-6 transition-opacity hover:opacity-80" fill="#1877F2"
              viewBox="0 0 24 24">
              <path
          ...
          <a href="https://www.instagram.com/mifolkloreargentino/" target="_blank" aria-label="Instagram">
            <svg class="w-6 h-6 transition-opacity hover:opacity-80" viewBox="0 0 24 24">
              <defs>
              ...
              <path fill="url(#ig-gradient-footer)"
          ...
          <a href="https://x.com/MiFolkloreArg" target="_blank" aria-label="X">
            <svg class="w-6 h-6 text-white hover:text-gray-300 transition-colors" viewBox="0 0 24 24"
              fill="currentColor">
              <path
