<footer class="bg-black text-white text-sm cv-auto">
      ...
      <div>
        ...
        <div class="flex space-x-3">
          <a href="https://www.facebook.com/MiFolkloreArgentino/" target="_blank" aria-label="Facebook"
            class="flex h-11 w-11 items-center justify-center rounded-lg bg-[#1877F2] transition-transform hover:scale-110">
          ...
          <a href="https://www.instagram.com/mifolkloreargentino/" target="_blank" aria-label="Instagram"
            class="flex h-11 w-11 items-center justify-center rounded-lg bg-gradient-to-tr from-[#FFDD55] via-[#E1306C] to-[#833AB4] transition-transform hover:scale-110">
            <svg class="w-5 h-5" fill="#ffffff" viewBox="0 0 24 24">
              <path
          ...
          <a href="https://x.com/MiFolkloreArg" target="_blank" aria-label="X"
            class="flex h-11 w-11 items-center justify-center rounded-lg bg-neutral-800 ring-1 ring-white/20 transition-transform hover:scale-110">
            <svg class="w-5 h-5" fill="#ffffff" viewBox="0 0 24 24">
              <path
