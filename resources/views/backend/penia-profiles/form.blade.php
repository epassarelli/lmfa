...
<div class="row">
  ...
  @else
    <div class="col-md-12"><div class="alert alert-info">Tu aporte se guardará como borrador pendiente. La verificación y publicación corresponden al equipo editorial.</div></div>
  @endif
