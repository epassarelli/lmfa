...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Convención: los nombres de campo en 'attributes' son sustantivos en
    | minúscula y sin artículo ("contraseña", no "La contraseña"), y los
    | mensajes anteponen "El campo :attribute". Así la concordancia de género
    | siempre cierra, sin importar si el campo es masculino o femenino.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Sustantivos en minúscula y sin artículo, para que encajen detrás de
    | "El campo ..." sin romper la concordancia.
    |
    */
