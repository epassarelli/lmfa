...
> Ultima actualizacion: 2026-09-04 (punto 7 en curso: CI completo verde; staging y smoke HTTPS pendientes; exposición pública aún apagada)
...
| 7 | Ejecutar tests, staging, smoke y recién entonces fusionar | `in progress`: CI completo verde en `f3827ae`; staging y smoke HTTPS reales pendientes |
